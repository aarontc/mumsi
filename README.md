...
echo net-libs/pjproject alsa amr ffmpeg g722 g7221 gsm ilbc ipv6 l16 libyuv openh264 opus resample sdl silk speex ssl webrtc
 >> /etc/portage/package.use/pjproject
